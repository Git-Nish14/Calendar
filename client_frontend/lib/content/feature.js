export const featureContent = {
    heroSection: {
      ...
      title2: "Transform Scheduling",
      subtitle: "Explore how Calendo's intuitive design and powerful functionality makes calendar management effortless and efficient."
    },
    highlightFeatures: [
      {
    ...
    howItWorks: [
      ...
      },
      {
        ...
        description: "Select between Day, Week, or Month views to focus on exactly what you need to see."
      },
      {
        title: "Create Events Effortlessly",
        description: "Simply drag across dates to create new events, with instant visual feedback on your calendar."
      },
      {
        title: "Edit Details in the Sidebar",
        description: "Add titles, adjust dates with popup calendars, and manage all event details in one place."
      },
      {
        title: "Easily Reschedule",
        description: "Drag and drop events to new dates when your plans change, with real-time updates."
      }
    ],
    ctaSection: {
