...
import { homeContent, benefitsList } from "@/lib/content/home";
    ...
    >
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          {/* Image Section */}
          <div
            className={`w-full lg:w-1/2 flex justify-center transition-all duration-700 ${inView ? "opacity-100" : "opacity-0 translate-x-12"
              }`}
          >
            <div className="relative">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl max-w-full lg:max-w-lg border border-gray-100 z-10">
                <img
                  src={homeContent.previewImageSrc}
                  alt={homeContent.previewImageAlt}
          ...
          >
            ...
            <div className="space-y-8">
              {benefits.map((benefit, index) => (
                ...
                >
                  <div
                    className={`flex items-start gap-4 p-4 rounded-xl transition-all ${activeIndex === index ? "bg-indigo-50" : ""
                      }`}
                  >
                    <div
                    ...
                    <div>
                      ...
                      <div className="hidden sm:block h-16 overflow-hidden">
                        <p
                          className={`text-gray-600 transition-all ${activeIndex === index ? "opacity-100" : "opacity-0"
                            }`}
                        >
                          {benefit.description}
                        </p>
